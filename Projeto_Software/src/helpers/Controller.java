        ...
        try {
            while (true) {
                ...
                if (tipo == 1) {
                    ...
                    if (obj.getString("status").isBlank() || obj.getString("cliente").isBlank() || obj.getString("pedido").isBlank()) {
